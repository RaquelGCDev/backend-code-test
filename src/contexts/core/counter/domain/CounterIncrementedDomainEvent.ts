...
export class CounterIncrementedDomainEvent extends DomainEvent {
  ...
  constructor(data: { aggregateId: string; total: number; eventId?: string; occurredOn?: Date }) {
    ...
    super({ eventName: CounterIncrementedDomainEvent.EVENT_NAME, aggregateId, eventId, occurredOn });
  ...
  static fromPrimitives(params: {
    ...
    return new CounterIncrementedDomainEvent({
      aggregateId,
